...
Field.setLanguage = function (locale) {
  // Get the language file, if don't exist launch english file ( default )
  try {
    fs.statSync(__dirname + path.sep + '..' + path.sep + 'lang' + path.sep + locale + '.js').isFile();
    lang = require('../lang/' + locale + '.js');
  } catch(err) {
    console.log('Express-form error: language file not found, english dictionary loaded');
...
Field.prototype.arrLength = function (from, to) {
  return this.add(function (arr) {
    if (value.length < from) {
      return { error: message || e.message || lang.isTooShort };
    }
    if (value.length > to) {
      return { error: message || e.message || lang.isTooLong };
    }
    return { valid: true };
  });
}
...
Field.prototype.custom = function(func, message) {
  ...
  if (func.length == 3) {
    return this.add(function(value, source, cb) {
      func(value, source, function(err, result) {
        if (err) return cb(new Error(message || err.message || lang.isInvalid));
  ...
  return this.add(function (value, source) {
    ...
    try {
      ...
      return { error: message || e.message || lang.isInvalid };
    }
    // Functions that return values are filters.
...
Field.prototype.ucFirst = Field.prototype.upperFirst = function () {
  return this.add(function (value) {
    return value.toString().charAt(0).toUpperCase() + value.toString().substr(1);
  });
};
...
// VALIDATE METHODS
var validatorPrototype = function () {
  Object.keys(ValidatorPrototype).forEach(function (name) {
    ...
    var MESSAGES = {
      ...
      isUrl: lang.isUrl,
      isIP: lang.isIP,
      isAlpha: lang.isAlpha,
      isAlphanumeric: lang.isAlphanumeric,
      isNumeric: lang.isNumeric,
      isLowercase: lang.isLowercase,
      isUppercase: lang.isUppercase,
      isInt: lang.isInt,
      notEmpty: lang.notEmpty
    };
...
Field.prototype.contains = function (test, message) {
  return this.add(function(value) {
    try {
      ...
      return { error: message || lang.contains };
    }
    return { valid: true };
  });
};
...
Field.prototype.notContains = function (test, message) {
  return this.add(function (value) {
    try {
      ...
      return { error: message || lang.notContains };
    }
    return { valid: true };
  });
};
...
Field.prototype.equals = function (other, message) {
  ...
  return this.add(function (value, source) {
    ...
    if (value != test) {
      return { error: message || lang.equals + String(test) };
    }
    return { valid: true };
  });
};
...
Field.prototype.isNumeric = function (message) {
  return this.add(function (value) {
    if (object.isNumber(value) || (object.isString(value) && value.match(/^[-+]?[0-9]*\.?[0-9]+$/))) {
      ...
      return { error: message || lang.isNumber };
    }
    return { valid: true };
  });
};
...
Field.prototype.isFloat = Field.prototype.isDecimal = function (message) {
  return this.add(function (value) {
    if ((object.isNumber(value) && value % 1 == 0) || (object.isString(value) && value.match(/^[-+]?[0-9]*\.[0-9]+$/))) {
      ...
      return { error: message || lang.isFloat };
    }
    return { valid: true };
  });
};
...
Field.prototype.isEmail = function (message) {
  return this.add(function (value) {
    if (typeof value != 'string' || !(/^[\-0-9a-zA-Z\.\+_]+@[\-0-9a-zA-Z\.\+_]+\.[a-zA-Z]{2,}$/).test(value)) {
      return { error: message || lang.isEmail };
    }
    return { valid: true };
  });
};
...
Field.prototype.isString = function (message) {
  return this.add(function (value) {
    if (!object.isString(value)) {
      return { error: message || lang.isString };
    }
    return { valid: true };
  });
};
...
Field.prototype.regex = Field.prototype.is = function (pattern, modifiers, message) {
  ...
  if (pattern instanceof RegExp) {
    if (object.isString(modifiers) && modifiers.match(/^[gimy]+$/)) {
      throw new Error(lang.invalidArguments);
    }
...
Field.prototype.required = function (placeholderValue, message) {
  ...
  return this.add(function (value) {
    if (!utils.hasValue(value) || value == placeholderValue) {
      return { error: message || lang.isRequired };
    }
    return { valid: true };
  });
};
...
Field.prototype.minLength = function (length, message) {
  return this.add(function(value) {
    if (value.toString().length < length) {
      return { error: message || lang.isTooShort };
    }
    return { valid: true };
  });
};
...
Field.prototype.maxLength = function (length, message) {
  return this.add(function(value) {
    if (value.toString().length > length) {
      return { error: message || lang.isTooLong };
    }
    return { valid: true };
  });
};
